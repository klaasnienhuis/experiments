...
window.apps = [
  {
    video:
      "https://klaasnienhuis.github.io/experiments/video-textures/videos/shazam.webm",
    camera: {
      position: [-5.20412822581436, -19.121745822133644, 3.154700374905264],
      target: [
        0.000005142699927019269, -0.3250986610075804, 0.0890636007763596,
      ],
    },
  },
  {
    video:
      "https://klaasnienhuis.github.io/experiments/video-textures/videos/yahoo.webm",
    camera: {
  ...
  {
    video:
      "https://klaasnienhuis.github.io/experiments/video-textures/videos/runtastic.webm",
    camera: {
  ...
  {
    video:
      "https://klaasnienhuis.github.io/experiments/video-textures/videos/facetune.webm",
    camera: {
  ...
  function (e) {
    ...
    if (url.replace("s") !== "") {
      ...
      swithToApp({
        ...
        camera: {
          position: [
            0.47380569188722443, -24.291117279406077, 1.7677300681241275,
          ],
          target: [
            0.000005142699927019269, -0.3250986610075804, 0.0890636007763596,
          ],
